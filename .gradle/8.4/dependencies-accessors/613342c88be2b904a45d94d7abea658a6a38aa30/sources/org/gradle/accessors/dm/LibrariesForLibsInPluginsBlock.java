...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        public VersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }
            ...
            /**
             * Returns the version associated to this alias: activity (1.8.1)
    ...
    public static class AndroidxLifecycleVersionAccessors extends VersionFactory  {
        ...
        private final AndroidxLifecycleLivedataVersionAccessors vaccForAndroidxLifecycleLivedataVersionAccessors = new AndroidxLifecycleLivedataVersionAccessors(providers, config);
        public AndroidxLifecycleVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.androidx.lifecycle.livedata
         */
        public AndroidxLifecycleLivedataVersionAccessors getLivedata() {
            return vaccForAndroidxLifecycleLivedataVersionAccessors;
        }

    }

    public static class AndroidxLifecycleLivedataVersionAccessors extends VersionFactory  {

        public AndroidxLifecycleLivedataVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: androidx.lifecycle.livedata.ktx (2.6.2)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKtx() { return getVersion("androidx.lifecycle.livedata.ktx"); }

    }

    public static class AndroidxNavigationVersionAccessors extends VersionFactory  {

        private final AndroidxNavigationFragmentVersionAccessors vaccForAndroidxNavigationFragmentVersionAccessors = new AndroidxNavigationFragmentVersionAccessors(providers, config);
        public AndroidxNavigationVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Returns the group of versions at versions.androidx.navigation.fragment
         */
        public AndroidxNavigationFragmentVersionAccessors getFragment() {
            return vaccForAndroidxNavigationFragmentVersionAccessors;
        }

    }

    public static class AndroidxNavigationFragmentVersionAccessors extends VersionFactory  {

        public AndroidxNavigationFragmentVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

            /**
             * Returns the version associated to this alias: androidx.navigation.fragment.ktx (2.7.5)
             * If the version is a rich version and that its not expressible as a
             * single version string, then an empty string is returned.
             * This version was declared in catalog libs.versions.toml
             */
            public Provider<String> getKtx() { return getVersion("androidx.navigation.fragment.ktx"); }
